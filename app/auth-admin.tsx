...
import AdminCommunity from './components/AdminCommunity'; // NOUVEAU composant Administration/Community
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.gamesGrid}>
            ...
            <TouchableOpacity style={styles.gameCard} onPress={() => setSelectedGame('community')}>
              <LinearGradient colors={['#475569', '#334155']} style={styles.gameIconContainer}>
                <Ionicons name="people" size={40} color="#FFF" />
              </LinearGradient>
              <Text style={styles.gameName}>Administration</Text>
              <Text style={styles.gameDescription}>Communauté & Users</Text>
            </TouchableOpacity>
