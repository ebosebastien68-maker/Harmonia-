      ...
      <View style={styles.container}>
        ...
        {loading ? (
          ...
          <View style={styles.center}>
            ...
            <Text style={styles.emptyText}>Les sessions apparaîtront ici une fois créées par l'admin</Text>
...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 20, fontWeight: 'bold', marginTop: 16, textAlign: 'center' },
  emptyText: { fontSize: 14, color: '#999', marginTop: 8, textAlign: 'center', paddingHorizontal: 32 },
  refreshButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#10B981', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12, marginTop: 24, gap: 8 },
  refreshText: { color: '#FFF', fontSize: 16, fontWeight: 'bold' },
  scroll: { flex: 1, padding: 16 },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 16 },
  card: { flexDirection: 'row', backgroundColor: '#FFF', padding: 16, borderRadius: 12, marginBottom: 12, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
  cardContent: { flex: 1 },
